...
const  LoggInn= (props) => {
   ...
   <Row>
    ...
    <Form onKeyDown={keyDownEvent} style={{width:"50%", marginLeft:"30%", marginTop:"10%"}}>
        ...
        <Form.Group controlId="formBasicPassword">
            ...
            <Form.Control type="password" placeholder="Passord" onChange={(evnet)=>{
                password=evnet.target.value;
            }} />
            <div className="text-info" hidden={!error}>Feil epost eller passord</div>
        </Form.Group>
    ...
    <Col>
    <Image src={LoggImage} thumbnail style={{border:"none"}}></Image>
    </Col>
