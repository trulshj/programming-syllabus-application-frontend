    ...
    <BrowserRouter>
      ...
      <UserStatusContext.Provider value={[userStatus,setUserStatus]}>
        ...
        <Switch>
          ...
          <Route path="/articlelist" exact component={ArticlesList}/>
          <Route path="/search/:id" component={ArticlesList}/>
          <Route path="/articlelist/myarticles" component={ArticlesList}/>
          <Route path="/articlelist/:id" component={ArticleDetails}/>
          <Route path="/logginn" component={LoggInn}/>
          <Route path="/Registration" component={Registration}/>
          <Route path="/usermeny" component={RegisteredUserMeny}/>
